...
<tr><td>Resource record(s) concurrent to the manifest metadata record </td><td>Configuration, report, log file. <p> Additional collection information explaining reasons to launch a crawl </td></tr>
</table>
</blockquote>
